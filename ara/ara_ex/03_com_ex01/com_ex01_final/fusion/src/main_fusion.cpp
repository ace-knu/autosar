...
void ThreadAct1()
{
    fusion::FusionActivity actFusion;
    actFusion.init();
...
void handle_signal(int _signal) {
    if(!quit.load() && (_signal == SIGINT || _signal == SIGTERM)) {
        logger.LogInfo() << "================ Fusion Terminate ================";
...
int main(int argc, char* argv[])
{
    ...
    ara::log::InitLogging("ACFA", "example app. fusion", LogLevel::kVerbose, (LogMode::kRemote | LogMode::kConsole));

    logger.LogInfo() << "@@@ Fusion start ###";

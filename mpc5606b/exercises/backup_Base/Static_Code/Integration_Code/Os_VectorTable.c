...
/* polyspace:begin<MISRA-C:2.1:Not a defect:Justify with annotations> In lined assembly is needed for readability and performance */
...
/* polyspace<MISRA-C:19.4:Not a defect:Justify with annotations> this macro does not have side effect. it is tested manually */
...
/* polyspace:end<MISRA-C:2.1:Not a defect:Justify with annotations>  In lined assembly is needed for readability and performance */

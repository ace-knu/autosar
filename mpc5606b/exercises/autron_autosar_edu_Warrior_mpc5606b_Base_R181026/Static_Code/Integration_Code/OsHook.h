...
typedef enum {
  ...
  _E_OS_CALLEVEL = E_OS_CALLEVEL,	/* Access to the service from the ISR is not permitted  */
  _E_OS_ID = E_OS_ID,				/* Object ID is invalid */
  _E_OS_LIMIT = E_OS_LIMIT,			/* Limit of services/objects exceeded   */
  _E_OS_NOFUNC = E_OS_NOFUNC,		/* The object is not used, service rejected */
  _E_OS_RESOURCE = E_OS_RESOURCE,	/* Task still occupies resource */
  _E_OS_STATE = E_OS_STATE,			/* The state of the object is not correct for the required service */
  _E_OS_VALUE = E_OS_VALUE,			/* Value outside of the admissible limit    */
  _E_OS_SERVICEID = E_OS_SERVICEID,	/* Service can not be called */
  _E_OS_ILLEGAL_ADDRESS = E_OS_ILLEGAL_ADDRESS,	/* An invalid address is given as a parameter to a service */
  _E_OS_MISSINGEND = E_OS_MISSINGEND,	/* Tasks terminates without a TerminateTask() or ChainTask() call */
  _E_OS_DISABLEDINT = E_OS_DISABLEDINT,	/* A service of the OS is called inside an interrupt disable/enable pair */
  _E_OS_STACKFAULT = E_OS_STACKFAULT,	/* A stack fault detected via stack monitoring by the OS */
  _E_OS_PROTECTION_MEMORY = E_OS_PROTECTION_MEMORY,	/* A memory access violation occurred */
  _E_OS_PROTECTION_TIME = E_OS_PROTECTION_TIME,	/* A Task/Category 2 ISR exceeds its execution time budget */
  _E_OS_PROTECTION_LOCKED = E_OS_PROTECTION_LOCKED,	/* A Task/Category 2 ISR blocks for too long */
  _E_OS_PROTECTION_EXCEPTION = E_OS_PROTECTION_EXCEPTION,	/* A trap occurred */
  _E_OS_PROTECTION_ARRIVAL = E_OS_PROTECTION_ARRIVAL,	/* A Task/Category 2 ISR arrives before its timeframe has expired */
  _E_OS_PROTECTION_ISR_ARRIVAL = E_OS_PROTECTION_ISR_ARRIVAL, /* additional error code. It is used only by OS. */

...
STATIC CONST(Mcu_RamConfigType, MCU_CONST) Mcu_RamConfigPC_1[1]  = {

    /* start of Mcu_RamConfig[0] */
    {
    ...
    (uint32)0x000000baUL /* value to be filled with */
    } /* end of Mcu_RamConfig[0] */

};


STATIC CONST(Mcu_ModeConfigType, MCU_CONST) Mcu_ModeConfigPC_1[3] ={
...
STATIC CONST(Mcu_ClockConfigType, MCU_CONST) Mcu_ClockConfigPC_1[2] = {/* start of Mcu_ClockConfig[1] */
    {
  /*McuPLL*/
...
STATIC CONST(McuLLD_ConfigType, MCU_CONST) McuLLD_ConfigPC_1 =
    {
        /* Run Config Mode0  */
...
CONST(Mcu_ConfigType, MCU_CONST) MCU_INIT_CONFIG_PC =
    {
        ...
        Mcu_RamConfigPC_1,             /* pointer to ram section configurations */
        Mcu_ModeConfigPC_1,            /* pointer to low power mode configurations */
        Mcu_ClockConfigPC_1,           /* pointer to clock settings configurations */
        &McuLLD_ConfigPC_1,             /*  pointer to low level*/

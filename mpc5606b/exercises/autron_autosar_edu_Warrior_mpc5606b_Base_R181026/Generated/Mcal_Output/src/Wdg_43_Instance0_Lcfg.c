...
{
    {
       ...
       /* SLOW Mode */
       {
           ( SWT_WDG_ENABLED |SWT_WDG_NO_HARD_LOCK | SWT_WDG_NO_SOFT_LOCK | SWT_TRIGGER_MODE_REGULAR |     SWT_TRIGGER_MODE_REGULAR |     SWT_FIXED_SERVICE_SEQ |     SWT_WDG_RUN_IN_HALT |     SWT_WDG_STOP_IN_DEBUG |     SWT_WDG_OSCILLATOR |          SWT_RESET_ON_TIMEOUT |          SWT_INVALID_ACCESS_GEN_SYSTEM_RESET      ), /* WDG Control and configuration */
       ...
       /* FAST Mode */
       {
           ( SWT_WDG_ENABLED | SWT_WDG_NO_HARD_LOCK | SWT_WDG_NO_SOFT_LOCK | SWT_TRIGGER_MODE_REGULAR |     SWT_TRIGGER_MODE_REGULAR |     SWT_FIXED_SERVICE_SEQ |     SWT_WDG_STOP_IN_HALT |     SWT_WDG_STOP_IN_DEBUG |     SWT_WDG_OSCILLATOR |          SWT_RESET_ON_TIMEOUT |          SWT_INVALID_ACCESS_GEN_SYSTEM_RESET      ), /* WDG Control and configuration */
